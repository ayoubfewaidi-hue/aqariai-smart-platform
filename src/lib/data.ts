...
const EXPLICIT_NEARBY: Record<string, string[]> = {
  "ناعور": ["ماحص", "البصّة", "أم الأسود", "الفحيص", "دير علا"],
  "عبدون": ["دابوق", "خلدا", "الصويفية", "أم أذينة", "الرابية"],
  "بدر الجديدة": ["السويسة", "الحديب", "أم الأسود", "البصّة", "ماحص"],
  "دابوق": ["خلدا", "تلاع العلي", "الجاردنز", "الرابية", "عبدون"],
  "الشميساني": ["العبدلي", "الصويفية", "تلاع العلي", "زهران", "راس العين"],
  "الصويفية": ["عبدون", "أم أذينة", "خلدا", "الشميساني", "دير غبار"],
  "خلدا": ["دابوق", "تلاع العلي", "الجاردنز", "الصويفية", "الرابية"],
  "مرج الحمام": ["ناعور", "بدر الجديدة", "خلدا", "اليادودة", "أم رمان"],
  "المقابلين": ["المقابلين الشرقي", "القويسمة", "أبو علندا", "اليادودة", "اليرموك"],
};
